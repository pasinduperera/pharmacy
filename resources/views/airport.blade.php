...
<div class="container" style="margin-top: 10px;">
    ...
    <h4><b>Airport Hires Definition</b></h4><br>
...
<script>
    ...
    // Get Data
    firebase.database().ref('airporthires/').on('value', function (snapshot) {
    ...
    $('#submitCustomer').on('click', function () {
        ...
        var waitingcost = values[5].value;
        var nexthours = values[6].value;
        var nexthourcost = values[7].value;
        var userID = lastIndex + 1;

        console.log(values);

        firebase.database().ref('airporthires/' + userID).set({
            packagen: packagen,
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('airporthires/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateCustomer').on('click', function () {
        ...
        var postData = {
            ...
            waitingcost: values[5].value,
            nexthours: values[6].value,
            nexthourcost: values[7].value,
        };

        var updates = {};
        updates['/airporthires/' + updateID] = postData;
    ...
    $('.deleteRecord').on('click', function () {
        ...
        firebase.database().ref('airporthires/' + id).remove();

...
<div class="container" style="margin-top: 10px;">
    ...
    <h4><b>Driver Registration</b></h4><br>

    <h5># Add Driver</h5>
    <div class="card card-default">
        <div class="card-body">
            <form name="my" id="addCustomer" class="form-inline" action="">
                <div class="form-group mb-2">
                    <label for="dname" class="sr-only">Driver Name</label>
                    <input id="dname" type="text" class="form-control" name="dname" placeholder="Driver Name"
                           required autofocus/><br>
                </div>
                <div class="form-group mb-2">
                    <label for="dmiddlename" class="sr-only">Driver's middle name</label>
                    <input id="dmiddlename" type="text" class="form-control" name="dmiddlename" placeholder="Driver Middle Name"
                           required autofocus/><br>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="daddress" class="sr-only">Address</label>
                    <input id="daddress" type="daddress" class="form-control" name="daddress" placeholder="Address"
                           required autofocus/>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="dbirthday" class="sr-only">BirthDay</label>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="dlno" class="sr-only">Driving Licence No</label>
                    <input id="dlno" type="dlno" class="form-control" name="dlno" placeholder="Driving Licence No"
                           required autofocus/>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="nicno" class="sr-only">Driver NIC No</label>
                    <input id="nicno" type="nicno" class="form-control" name="nicno" placeholder="Driver NIC No"
                           required autofocus/>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="nicimage" class="sr-only">Driver NIC image</label>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="dimage" class="sr-only">Driver Image</label>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="accountno" class="sr-only">Account No</label>
          ...
          <input type="text" id="email_id" name="emailname" placeholder=""/>
          &nbsp;&nbsp;&nbsp;
          <label for="password" style="font-size:13pt;">Password</label>
          <input type="password" id="password" name="passwordname" placeholder=""/>
          <br/><br/>
         
          <button id="submitCustomer" class="btn btn-primary mb-2"  display="block" name="signup" type="submit" onClick="handleSignUp()">Sign Up</button>
...
<script>
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('drivers/' + updateID).on('value', function (snapshot) {
            ...
            <div class="col-md-12">\
                <input id="dname" type="text" class="form-control" name="dname" value="' + values.dname + '" required autofocus>\
            </div>\
        </div>\
        <div class="form-group">\
            <label for="dmiddlename" class="col-md-12 col-form-label">Driver Middle Name</label>\
            <div class="col-md-12">\
                <input id="dmiddlename" type="text" class="form-control" name="dmiddlename" value="' + values.dmiddlename + '" required autofocus>\
            </div>\
        </div>\
        <div class="form-group">\
            <label for="daddress" class="col-md-12 col-form-label">Address</label>\
            <div class="col-md-12">\
                <input id="daddress" type="text" class="form-control" name="daddress" value="' + values.daddress + '" required autofocus>\
            </div>\
        </div>\
            <div class="form-group">\
                <label for="dbirthday" class="col-md-12 col-form-label">Driver Birthday</label>\
                <div class="col-md-12">\
                    <input id="dbirthday" type="date" class="form-control" name="dbirthday" value="' + values.dbirthday + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
            ...
            <div class="form-group">\
                ...
                <div class="col-md-12">\
                    <input id="age" type="text" class="form-control" name="age" value="' + values.age + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="dlno" class="col-md-12 col-form-label">Driving Licence No</label>\
                <div class="col-md-12">\
                    <input id="dlno" type="text" class="form-control" name="dlno" value="' + values.dlno + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="nicno" class="col-md-12 col-form-label">NIC No</label>\
                <div class="col-md-12">\
                    <input id="nicno" type="text" class="form-control" name="nicno" value="' + values.nicno + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="nicimage" class="col-md-12 col-form-label">NIC Image</label>\
                <div class="col-md-12">\
                    <input id="nicimage" type="text" class="form-control" name="nicimage" value="' + values.nicimage + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="gender" class="col-md-12 col-form-label">Gender</label>\
                <div class="col-md-12">\
                    <input id="gender" type="text" class="form-control" name="gender" value="' + values.gender + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="dimage" class="col-md-12 col-form-label">Driver Image</label>\
                <div class="col-md-12">\
                    <input id="dimage" type="text" class="form-control" name="dimage" value="' + values.dimage + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="bankname" class="col-md-12 col-form-label">Bank Name</label>\
                <div class="col-md-12">\
                    <input id="bankname" type="text" class="form-control" name="bankname" value="' + values.bankname + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="accountno" class="col-md-12 col-form-label">Account No</label>\
                <div class="col-md-12">\
                    <input id="accountno" type="text" class="form-control" name="accountno" value="' + values.accountno + '" required autofocus>\
                </div>\
            </div>\
            <div class="form-group">\
                <label for="email" style="font-size:13pt;">User Name</label>\
                <div class="col-md-12">\
                    <input id="email_id" type="text" class="form-control" name="emailname" value="' + values.email + '" required autofocus>\
                </div>\
            </div>';
